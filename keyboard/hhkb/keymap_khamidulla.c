...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    KEYMAP(ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSLS,GRV,   \
           ...
           FN1, A,   S,   D,   F,   G,   H,   J,   K,   L,   FN3, QUOT,FN2,             \
           LSFT,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,RSFT,FN0,             \
                LALT,LGUI,          FN4,                RGUI,RALT),
     ...
     * |Pwr| F1| F2| F3| F4| F5| F6| F7| F8| F9|F10|F11|F12|Ins|Del|
     * |-----------------------------------------------------------|
     * |Caps |MwL|Mb1|McU|Mb2|MwR|   |PgU|Up |PgD|Psk|Slk|Pus|Backs|
     * |-----------------------------------------------------------|
     * |      |MwD|McL|McD|McR|MwU|Hom|Lef|Dow|Rig|End|   |Enter   |
     * |-----------------------------------------------------------|
     * |        |   |   |   |   |   |   |   |   |   |   |      |   |
     * `-----------------------------------------------------------'
     *       |   |     |                       |     |   |
     ...
     */
    KEYMAP(PWR, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, INS, DEL,   \
           CAPS,WH_L,BTN2,MS_U,BTN1,WH_R,TRNS,PGUP, UP ,PGDN,PSCR,SLCK,PAUS, BSPC,      \
           TRNS,WH_D,MS_L,MS_D,MS_R,WH_U,HOME,LEFT,DOWN,RGHT, END,TRNS,PENT,            \
...
const action_t fn_actions[] PROGMEM = {
    ...
    [2] = ACTION_MODS_TAP_KEY(MOD_RCTL, KC_ENT),
    [3] = ACTION_MODS_TAP_KEY(MOD_RALT, KC_SCLN),
    [4] = ACTION_LAYER_TAP_KEY(2, KC_SPACE),
};
#endif
